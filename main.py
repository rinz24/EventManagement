...
class EventManagementSystem:
    def __init__(self, root):
        ...
        invitation_btn = Button(btn_frame, text="Invitation", command=self.invitation_details, width=22, font=("times new roman", 14, "bold"), bg="green", fg="white", bd=0, cursor="hand1")
